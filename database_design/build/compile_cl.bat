...
REM LINK PROGRAM
cl /nologo /Zi /GR- /EHs /W3 /MDd /Fe:database_design_d.exe *.obj ..\deps\esat\bin\ESAT_d.lib opengl32.lib user32.lib gdi32.lib shell32.lib /link /IGNORE:4099

REM COPY FILES
xcopy database_design_d.exe ..\bin\ /L /Y
